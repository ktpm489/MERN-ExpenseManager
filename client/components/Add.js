                ...
                <div>
                    ...
                    <Modal isOpen={this.state.modalIsOpen}
                        ...
                        <fieldset>
                            ...
                            <label for="Amount">Amount</label><input type="number" id="amount" name="amount" value={this.state.amount} onChange={this.handleTextChange} />
                            <label for="month">Mounth:</label>
                        ...
                        <div className="button-center">
                            <br />
                            <Button bsStyle="success" bsSize="small" onClick={this.onClick}>Add New Express</Button>
                        </div>
                    </Modal>
                </div>
            )
